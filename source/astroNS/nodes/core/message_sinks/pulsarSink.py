...
from nodes.pydantic_models.two_six_messages import WrappedOutputMessage, SimulationStepCompletePayload, CollectedTargetDataPayload
...
class PulsarTopicSink(BaseNode):
    ...
    def __init__(self, env: Environment, name: str, configuration: Dict[str, Any]):
        ...
        self.pydantic_classes = {
            ...
            "WrappedOutputMessage": WrappedOutputMessage,
            "SimulationStepCompletePayload": SimulationStepCompletePayload,
            "CollectedTargetDataPayload": CollectedTargetDataPayload
        }
