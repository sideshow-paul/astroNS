...
function main() {
    ...
    try {
        ...
        // Setting the imageryProver to that will allow access offline.
        viewer = new Viewer('cesiumContainer', {
            ...
            // disables flying to addresses and landmarks using the Cesium ion API.
            geocoder : false
        });
